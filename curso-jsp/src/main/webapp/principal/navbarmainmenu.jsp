...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
 ...
 <c:set scope="session" var="perfil" value='<%= request.getSession().getAttribute("perfil") %>'></c:set> <!--.toString()  -->
        ...
        <ul class="pcoded-item pcoded-left-item">
            <li>
                <a href="<%= request.getContextPath() %>/principal/reluser.jsp" class="waves-effect waves-dark">
                    ...
                    <span class="pcoded-mtext" data-i18n="nav.form-components.main">Relatório Usuário</span>
                    <span class="pcoded-mcaret"></span>
                </a>
            </li>
