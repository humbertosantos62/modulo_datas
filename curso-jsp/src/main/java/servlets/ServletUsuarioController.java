...
public class ServletUsuarioController extends ServletGenericUtil {
			 ...
			 if (acao != null && !acao.isEmpty() && acao.equalsIgnoreCase("deletar")) {
				 ...
				 if (modelLogin.getFotouser() != null && !modelLogin.getFotouser().isEmpty()) {
					 ...
					 if(acao.equalsIgnoreCase("imprimirRelatorioPDF")) {
					    relatorio = new ReportUtil().geraReltorioPDF(modelLogins, "relat-user", params ,request.getServletContext());
					    extensal = "pdf";
					 } else
						 if (acao.equalsIgnoreCase("imprimirRelatorioExcel")) {
							 relatorio = new ReportUtil().geraReltorioExcel(modelLogins, "relat-user", params ,request.getServletContext());
							 extensal = "xls"; 
						 }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			rendaMensal =  rendaMensal.split("\\ ")[1].replaceAll("\\ ", "").replaceAll("\\.", "").replaceAll("\\,", ".");	
			...
			modelLogin.setCodigopostal(codigopostal);
			modelLogin.setMorada(morada);
			modelLogin.setLocalidade(localidade);
			modelLogin.setFreguesia(freguesia);
			modelLogin.setConcelho(concelho);
			modelLogin.setDistrito(distrito);
